...
public:
    ...
    void Print() const;                     //7.lose 'const'

private:
    const string name;                      //6.name is const
    int age;
};                                          //2.lose ';'

Person::Person(string n ,int a) : name(n){    //3.lose 'Person::' 4.
    //name = n;                             //6.lose 'const'
    age = a;
}

void Person::Print() const{                 //3.lose 'Person::' 7.
